...
That's it. On first use, the skill helps the agent route into the right Glubean workflow: docs, onboarding, contract-first, or project work. For `glubean init`, the skill expects the user to run the interactive CLI themselves.
