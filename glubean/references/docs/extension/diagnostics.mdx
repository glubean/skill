...
If problems are detected, the output includes specific suggestions (e.g. "CLI version is outdated, run `npm install -g glubean@latest`").
...
|---|---|---|
| `$(alert) Glubean CLI` (yellow) | CLI not installed | Runs `npm install -g glubean` |
| `$(arrow-up) CLI 0.1.12 -> 0.1.15` | Update available | Runs `npm install -g glubean@latest` |
