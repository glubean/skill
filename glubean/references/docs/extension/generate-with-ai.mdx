...
<Callout type="info">
**One prerequisite: a Glubean project.** Run `npx glubean init` first so the AI can see `package.json`, the `@glubean/sdk` dependency, and your `tests/` / `explore/` layout. Without this context, it generates generic Node/Jest-style code instead of Glubean tests.
</Callout>
