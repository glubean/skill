...
Make sure you are in a Glubean project root (created by `npx glubean@latest init`).
...
- [Quick Start](/extension/quick-start) — install the extension and run `npx glubean@latest init`
