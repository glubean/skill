...
Glubean has **two distinct plugin concepts**. Which one you use depends on what you're extending.
...
The legacy `definePlugin((runtime) => T)` overload was removed in favor of `defineClientFactory`. Use whichever matches your intent below.
