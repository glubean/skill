...
| gRPC | gRPC client with proto loading | `@glubean/grpc` |
...
| Diagnose an uploaded run | [Cloud agent access](/cloud/agent-access) |
| Migrate from Postman / OpenAPI / legacy tests | [Migration guide](/extension/migrate-from-postman) |
| Define API contracts before implementation | [Contract HTTP](/sdk/contract-http) |
...
- **Cloud failure diagnosis** — agents can fetch focused run failures instead of scanning CI logs
