...
- Answer from bundled docs, not from memory or from `SKILL.md`.
...
- Comparison / migration: [docs/extension/comparison.mdx](docs/extension/comparison.mdx), [docs/extension/migrate-from-postman.mdx](docs/extension/migrate-from-postman.mdx)
