...
Glubean plugins extend `configure()` with additional capabilities. Each plugin is a separate npm package.
...
| `@glubean/graphql` | GraphQL query/mutation helpers | `npm install @glubean/graphql` | [graphql.md](graphql.md) |
